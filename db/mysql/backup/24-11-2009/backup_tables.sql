...
-- --------------------------------------------------------
-- 
-- Struttura della tabella `commenti_news`
-- 
DROP TABLE IF EXISTS `commenti_news`;
CREATE TABLE IF NOT EXISTS `commenti_news` (
  `id_commento` int(10) unsigned NOT NULL auto_increment,
...
-- --------------------------------------------------------
-- 
-- Struttura della tabella `commenti_prodotto`
-- 
DROP TABLE IF EXISTS `commenti_prodotto`;
CREATE TABLE IF NOT EXISTS `commenti_prodotto` (
  `id_commento` int(10) unsigned NOT NULL auto_increment,
  `id_prodotto` int(10) unsigned NOT NULL,
  `id_utente` int(10) NOT NULL,
  `commento` text,
...
CREATE TABLE `user_preference` (
  ...
  `id_usr_comment` int(10) unsigned NOT NULL,
  `type` int(1) unsigned NOT NULL,
  `value` text,
