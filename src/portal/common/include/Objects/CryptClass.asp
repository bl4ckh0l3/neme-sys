...
Class CryptClass
   ...
   End Function
	...
	'*********************************************  VERSIONE ALTERNATIVA PER LA CREAZINONE DI UNA CHIAVE CRIPTATA
	'Function gKeyLen()
		'gKeyLen = CInt(512)
	'End Function
	...
	Function gKeyString()
		' chiave da 512
		'gKeyString= "JP]8MY\<MHVN'\K#'?L7.$@PZE52C1K3I\&[/O1_J]6Q?/C>NU\H0@G]@(U6A^T_`*:,^(0P0I$7?\1G>'OE=G_JZ9;>ASX./+D(X3%0V<JB]<]_N$M1QKS6F+NL>`#;IO0QUCW`[*S5V\U+Y>@K'\,DZ/9%2Y;+LL&.P,UEVA+Q%Q`H;*RW6O2V48'EVN-^QRN;C=(>$88X@-K[KV/W:51N*8>3(SA:4TV>(IV.Y>'M$?]G&9=N,]3OW_./[9C]KC(87%.7UE_1HZ#,#A+<F]A:W$Z;0P<-4P+,,]6;1AMF*S#,[`]%DF'1C44Y\/7GF0IX@I:\C#ZNA;**.KCH]*,T5B_L\#<P\Q0C.8D=*Z1LH`@G12D*NX[IEAJU+@V+R*E-0<\><\:B:X1'?FIKO'A1P$[8?WO7@(6U>)PCUZ^1O6E*2;?/Z%%,/Y@4S=3W??,CTM(-OGKYCHH2%BNT,&P[;W_L%AH0,#N5->,\ER*AN#D`1M_B::O&OM&C*6[_"
		
		' chiave da 256
		gKeyString= "8FIP1.-+.'HV9_N7S3?;MA2V39&>KU)7(=N<;(5.JWTQ,&+#MT.4WBN%YVSXBV7T26`RTC*>Q]0/DG>;N1=X0-=O6$F9;^AP0#)U8QS=Z-D2=YP$19W,MSE;#P'^2@OM<4QH^&=MA6;[P./=M_).,I3I9P^M^L..1[D,CP1Q]*?/7U^+@VX`D^NZRUXG>U&Q(M,A^'8*K;:.,%/M#OQIQ($RJP?LG.?[;:2K-7[9%[UY)+'HM=>(M5;R:5<^6'F/"
	End Function
	...
	Function EnCrypt(strCryptThis)
	   ...
	   for i = 1 to Len(strCryptThis)
		  iKeyChar = Asc(mid(gKeyString(),i,1))
	...
	'Function HexDump(strToDump)
		'HexDump = ""
		'for x = 1 to len(strTemp)
		'HexDump = HexDump & right(string(2,"0") & hex(asc(mid(strTemp, x, 1))),2) & " "
		'if x mod 26 = 0 then vbCRLF
		'next
	'End Function
