...
Private Sub Class_Initialize()
	...
	response.write("mstrCachedMemoryName: "&mstrCachedMemoryName&"<br>")
	...
	End If
	response.write("mstrDynURL: "&mstrDynURL&"<br>")	
...
Public Sub AutoCacheToMemory()
	...
	response.write("mstrCacheCommand: "&mstrCacheCommand&"<br>")
	
	Select Case mstrCacheCommand
	
		Case vbNullString 
			response.write("mstrCacheCommand: entro nel case vbNullString<br>")
			...
			If err.number = 0 Then
				response.write("mstrCacheCommand: faccio render in memory<br>")
