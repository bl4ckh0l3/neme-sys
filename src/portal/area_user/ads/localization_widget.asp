<%if(Trim(Application("googlemaps_key"))<>"")then%>
	...
	function savePoint(id,latitude,longitude,txtinfo,id_element,type_elem,counter){
		...
		$.ajax({
			type: "POST",
			url: "<%=Application("baseroot") & "/area_user/ads/ajaxsavepoint.asp"%>",
			data: query_string,
	...
	function addPoint(counter){
		$("#addpointhere").append('<br/><div id="divLocalization'+counter+'" align="left">');
		...
		$("#latitude_container"+counter).append('<br/>');
		$("#latitude_container"+counter).append('<%=lang.getTranslated("backend.commons.detail.table.label.longitude")%>&nbsp;');
		$("#latitude_container"+counter).append($('<input type="text"/>').attr('name', "longitude").attr('class', "formFieldTXTMedium").attr('value', "").attr('id', "longitude"+counter).keypress(function(event) {return isDouble(event); }));
		...
		$("#button_group_container"+counter).append($('<textarea/>').attr('name', "txtinfo").attr('class', "formFieldTXTAREA").attr('id', "txtinfo0"+counter));
		var render='&nbsp;&nbsp;<a href="';
		render+="javascript:checkLocalization($('#txtinfo0"+counter+"').val(),'map',"+counter+");";
		render+='"><img src="<%=Application("baseroot")&"/editor/img/world_go.png"%>" title="<%=lang.getTranslated("backend.commons.detail.table.label.check_loc")%>" alt="<%=lang.getTranslated("backend.commons.detail.table.label.check_loc")%>" hspace="4" vspace="0" border="0" align="top"></a>';
		...
		render+='"><img src="<%=Application("baseroot")&"/editor/img/delete.png"%>" title="<%=lang.getTranslated("backend.commons.detail.table.label.delete")%>" alt="<%=lang.getTranslated("backend.commons.detail.table.label.delete")%>" hspace="4" vspace="0" border="0" align="top"></a></span>';
		...
		$("#button_group_container2"+counter).append($('<textarea/>').attr('name', "txtinfo").attr('class', "formFieldTXTAREA").attr('id', "txtinfo1"+counter));
		render='&nbsp;&nbsp;<a href="';
	...
	&nbsp;<a href="javascript:addPoint(pointCounter);"><img src="<%=Application("baseroot")&"/editor/img/add.png"%>" title="<%=lang.getTranslated("backend.commons.detail.table.label.add_point")%>" alt="<%=lang.getTranslated("backend.commons.detail.table.label.add_point")%>" hspace="5" vspace="0" border="0"></a></div>
	...
	for each p in objPoints
		...
		&nbsp;<span style="vertical-align:top;padding-right:4px;"><%=lang.getTranslated("backend.commons.detail.table.label.txtinfo")%></span><textarea name="txtinfo" id="txtinfo0<%=tmpcounter%>" class="formFieldTXTAREA"><%=txtinfo%></textarea>
		&nbsp;<a href="javascript:checkLocalization($('#txtinfo0<%=tmpcounter%>').val(),'map',<%=tmpcounter%>)"><img src=<%=Application("baseroot")&"/editor/img/world_go.png"%> vspace="0" hspace="4" border="0" align="top" alt="<%=lang.getTranslated("backend.commons.detail.table.label.check_loc")%>" title="<%=lang.getTranslated("backend.commons.detail.table.label.check_loc")%>"></a>
		...
		<div style="padding-left:5px;">
		&nbsp;<span style="vertical-align:top;padding-right:4px;"><%=lang.getTranslated("backend.commons.detail.table.label.txtinfo")%></span><textarea name="txtinfo" id="txtinfo1<%=tmpcounter%>" class="formFieldTXTAREA"><%=txtinfo%></textarea>
	...
	<div style="padding-left:5px;">
	&nbsp;<span style="vertical-align:top;padding-right:4px;"><%=lang.getTranslated("backend.commons.detail.table.label.txtinfo")%></span><textarea name="txtinfo" id="txtinfo00" class="formFieldTXTAREA"></textarea>
	&nbsp;<a href="javascript:checkLocalization($('#txtinfo00').val(),'map',0)"><img src=<%=Application("baseroot")&"/editor/img/world_go.png"%> vspace="0" hspace="4" border="0" align="top" alt="<%=lang.getTranslated("backend.commons.detail.table.label.check_loc")%>" title="<%=lang.getTranslated("backend.commons.detail.table.label.check_loc")%>"></a>
	...
	<span id="deletepoint00">&nbsp;<a href="javascript:deletePoint($('#id0').val(),0);"><img src=<%=Application("baseroot")&"/editor/img/delete.png"%> vspace="0" hspace="4" border="0" align="top" alt="<%=lang.getTranslated("backend.commons.detail.table.label.delete")%>" title="<%=lang.getTranslated("backend.commons.detail.table.label.delete")%>"></a></span>
	</div>
	</div>
	...
	<div style="padding-left:5px;">
	&nbsp;<span style="vertical-align:top;padding-right:4px;"><%=lang.getTranslated("backend.commons.detail.table.label.txtinfo")%></span><textarea name="txtinfo" id="txtinfo10" class="formFieldTXTAREA"></textarea>
	&nbsp;<a href="javascript:checkLocalization($('#txtinfo10').val(),'map',0)"><img src=<%=Application("baseroot")&"/editor/img/world_go.png"%> vspace="0" hspace="4" border="0" align="top" alt="<%=lang.getTranslated("backend.commons.detail.table.label.check_loc")%>" title="<%=lang.getTranslated("backend.commons.detail.table.label.check_loc")%>"></a>
	...
	<span id="deletepoint10">&nbsp;<a href="javascript:deletePoint($('#id0').val(),0);"><img src=<%=Application("baseroot")&"/editor/img/delete.png"%> vspace="0" hspace="4" border="0" align="top" alt="<%=lang.getTranslated("backend.commons.detail.table.label.delete")%>" title="<%=lang.getTranslated("backend.commons.detail.table.label.delete")%>"></a></span>
	</div>
	</div>
	</div>
	<script language="Javascript">
