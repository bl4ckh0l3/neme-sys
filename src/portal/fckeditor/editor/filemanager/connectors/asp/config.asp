...
ConfigUserFilesPath = Application("baseroot")&Application("dir_editor_upload")
...
ConfigFileTypesPath.Add "Flash", ConfigUserFilesPath
...
ConfigFileTypesPath.Add "Media", ConfigUserFilesPath
