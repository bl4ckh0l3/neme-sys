...
<table class="tableContainer" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<table class="tableContent" border="0" align="left" cellpadding="0" cellspacing="0">
	  <tr>
		<td class="tdContent" align="center"><img src="<%="http://" & request.ServerVariables("SERVER_NAME") & Application("baseroot")&Application("dir_upload_templ")&"newsletter/img/newsletter_2.jpg"%>" vspace="0" hspace="0" border="0"></td>
	  </tr>
	  <tr>
		<td class="tdContent">
