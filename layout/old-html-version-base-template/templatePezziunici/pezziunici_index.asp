...
<table class="tableContainer" border="0" cellpadding="0" cellspacing="0" align="left">
  ...
  <tr>
	...
	<!--IFRAME src="pezziunici_list.asp?gerarchia=<%=strGerarchia%>" width="670" height="332" scrolling="auto" frameborder="0" hspace="0" vspace="0" allowtransparency="yes"></IFRAME-->
	<div class="box">
		<%
