...
<table class="tableContainer" border="0" cellpadding="0" cellspacing="0" align="left">
  ...
  <tr>
	...
	<tr>
	<td><img src="<%=Application("baseroot")&Application("dir_upload_templ")&"templatePromozionieventi/img/sfondo_center.jpg"%>" vspace="0" hspace="0" border="0"></td>
	<td>
	<!--IFRAME src="promozionieventi_list.asp?gerarchia=<%=strGerarchia%>" width="450" height="332" scrolling="auto" frameborder="0" hspace="20" vspace="0" allowtransparency="yes" class="iFrameStyle"></IFRAME-->
	<div class="box">
		<%
