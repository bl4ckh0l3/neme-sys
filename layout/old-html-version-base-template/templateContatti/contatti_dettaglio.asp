  ...
  <tr>
	...
	<table class="tableContent" border="0" align="left" cellpadding="0" cellspacing="0">
	  <tr>
		...
		<img src="<%=Application("baseroot")&Application("dir_upload_templ")&"templateContatti/img/header.jpg"%>" vspace="0" hspace="0" border="0" align="top">		
		</td>
		</tr>
	  <tr>
	  ...
	  <tr>
		...
		if bolHasObj then
			...
			<td class="tdContentSx"><img src="<%=Application("baseroot")&Application("dir_upload_templ")&"templateContatti/img/pulsante_arancione.gif"%>" vspace="32" hspace="0" border="0" align="top"></td>
			<td class="tdContent">
		...
		<img src="<%=Application("baseroot")&Application("dir_upload_templ")&"templateContatti/img/logo_santenini_small.gif"%>" vspace="0" hspace="0" border="0"><br>
