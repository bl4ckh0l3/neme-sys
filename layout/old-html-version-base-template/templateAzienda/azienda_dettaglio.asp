  ...
  <tr>
	...
	<table class="tableContent" border="0" align="left" cellpadding="0" cellspacing="0">
	  <tr>
		...
		<img src="<%=Application("baseroot")&Application("dir_upload_templ")&"templateAzienda/img/header.jpg"%>" vspace="0" hspace="0" border="0" align="top">		
		</td>
		</tr>
	  <tr>
	  ...
	  <tr>
		...
		if bolHasObj then
			...
			<td class="tdContentSx"><img src="<%=Application("baseroot")&Application("dir_upload_templ")&"templateAzienda/img/pulsante_arancione.gif"%>" vspace="32" hspace="0" border="0" align="top"></td>
			<td class="tdContent">			
		...
		<td class="tdContent"><%response.Write("<div align=""center""><b>"& lang.getTranslated("portal.commons.templates.label.page_in_progress")&"</b></div>")
		end if%>
		</td>
		<td class="tdContentDx">
		<img src="<%=Application("baseroot")&"/templates/templateAzienda/img/logo_santenini_small.gif"%>" vspace="0" hspace="0" border="0"><br>
	  ...
	  <tr>
		<td colspan="2" class="tdContentColspan"><!-- #include virtual="/common/include/MenuFruizioneBottom.inc" --><br/></td>
