...
<table class="tableContainer" border="0" cellpadding="0" cellspacing="0" align="left">
  ...
  <tr>
	...
	<tr>
	<td class="tdContentSx"><%=lang.getTranslated("frontend.template_produzione.label.txt_intro")%>
	<img src="<%=Application("baseroot")&"/common/img/spacer.gif"%>" height="2" vspace="0" hspace="0" border="0" width="237"></td>
	<td>
	<!--IFRAME src="produzione_list.asp?gerarchia=<%=strGerarchia%>" width="670" height="332" scrolling="auto" frameborder="0" hspace="0" vspace="0" allowtransparency="yes"></IFRAME-->
	<div class="box">
		<%
